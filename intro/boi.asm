...
scroll_char:
	.byte 0
scroll_text:
	.text "whoah! this is me, teh king! i'm going to the cinema to see funny dinnur for! "
	.text "whoahahahahahah! "
	.text "sup admbot, laten we maar aan xtcommon v1.0 werken! "
	.text "best wel veel ship moeten we nog maken, maar dat komt vast wel goed ....... ... .. .           "
	.byte $ff
