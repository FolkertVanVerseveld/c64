...
regel_tabel_rechts_eind:
	...
	.byte 0
regel1_links:
	.text "yo, there we are agai"
regel1_rechts:
	.byte 'n'
	.byte 0
regel2_links:
	.text "brewing demos at the hcc"
regel2_rechts:
	.byte '!'
	.byte 0
regel3_links:
	.text "lets make something cool"
regel3_rechts:
	.byte '!'
	.byte 0
regel4_links:
	.text "this is a little exampl"
regel4_rechts:
	.byte 'e'
	.byte 0
regel5_links:
	.text "this took a couple of hour"
regel5_rechts:
	.byte 's'
	.byte 0
regel6_links:
	.text "looks sweet right"
regel6_rechts:
	.byte '?'
	.byte 0
regel7_links:
...
regel12_rechts:
	...
	.byte 0
regel13_links:
	.text "at revision 2018 i release"
regel13_rechts:
	.byte 'd'
	.byte 0
regel14_links:
...
regel14_rechts:
	...
	.byte 0
regel15_links:
	.text "and since then i joine"
regel15_rechts:
	.byte 'd'
	.byte 0
regel16_links:
	.text "the demogroup f4cg"
regel16_rechts:
	.byte '!'
	.byte 0
regel17_links:
	.text "ze smasher asked me to joi"
regel17_rechts:
	.byte 'n'
	.byte 0
regel18_links:
	.text "and i gladly accepted"
regel18_rechts:
	.byte '!'
	.byte 0
regel19_links:
	.text "also, anton, who woke up from hi"
regel19_rechts:
	.byte 's'
	.byte 0
regel20_links:
	.text "scene hibernation, and m"
regel20_rechts:
	.byte 'e'
	.byte 0
regel21_links:
	.text "are going to foun"
regel21_rechts:
	.byte 'd'
	.byte 0
regel22_links:
...
regel24_links:
	.text "cool demo at x201"
regel24_rechts:
	.byte '8'
	.byte 0

regel25_links:
	.text "currently, we are tryin"
regel25_rechts:
	.byte 'g'
	.byte 0
regel26_links:
	.text "things out and hacking aroun"
regel26_rechts:
	.byte 'd'
	.byte 0
regel27_links:
	.text "but we can't promise w"
regel27_rechts:
	.byte 'e'
	.byte 0
regel28_links:
	.text "can release something on time"
regel28_rechts:
	.byte '!'
	.byte 0
